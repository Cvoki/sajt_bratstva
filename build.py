...
<section class="section">
  <div class="wrap wrap--narrow">
    <p class="notice">✎ Вијести ће се додавати кроз једноставан админ (Decap CMS): наслов, текст, слике и „Објави“ — без икаквог кода. Испод су примјери како ће изгледати објаве.</p>
    <div class="news-list">
      <article class="news-item reveal">
        <time datetime="2026-10-31">31. октобар 2026.</time>
        <h3>Прослава крсне славе — Свети Лука</h3>
        <p>Позив свим члановима братства на заједничку прославу славе. <em>(примјер објаве)</em></p>
      </article>
      <article class="news-item reveal">
        <time datetime="2026-08-01">1. август 2026.</time>
        <h3>Годишње окупљање братства</h3>
        <p>Обавјештење о датуму и мјесту окупљања. <em>(примјер објаве)</em></p>
      </article>
    </div>
  </div>
</section>
